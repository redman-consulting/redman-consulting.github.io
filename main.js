...
function rcIconSvg(iconName) {
  ...
  return `<img src="${iconMap(iconName)}.svg" alt="" />`;
}
...
function renderFooter() {
  ...
  <div class="wrap">
    ...
    <div class="footer-bottom">
      ...
      <nav><a href="index.html">Home</a><a href="about.html">About</a><a href="blog.html">Blog</a><a href="contact.html">Contact</a></nav>
    </div>
  </div>`;
}
